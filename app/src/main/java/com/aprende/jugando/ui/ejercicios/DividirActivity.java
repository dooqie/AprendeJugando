...
public class DividirActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        juegoLayout = findViewById(R.id.juegoLayoutDividir);
        ...
        ButtonAnimUtils.addBounce(this, opcion1Button, opcion2Button, opcion3Button, opcion4Button,
                findViewById(R.id.btnVolverDividir));
    }

    private void inicializarVistas() {
        preguntaTextView = findViewById(R.id.preguntaTextViewDividir);
        timerTextView = findViewById(R.id.timerTextViewDividir);
        scoreTextView = findViewById(R.id.scoreTextViewDividir);
        nivelTextView = findViewById(R.id.nivelTextViewDividir);
        opcion1Button = findViewById(R.id.opcion1ButtonDividir);
        opcion2Button = findViewById(R.id.opcion2ButtonDividir);
        opcion3Button = findViewById(R.id.opcion3ButtonDividir);
        opcion4Button = findViewById(R.id.opcion4ButtonDividir);
    ...
    private void configurarPreguntas() {
        ...
        int divisor = minF + random.nextInt(maxF - minF + 1);
        int cociente = minF + random.nextInt(maxF - minF + 1);
        int dividendo = divisor * cociente;
        int respuestaCorrecta = cociente;

        preguntaTextView.setText(String.format("%d ÷ %d = ?", dividendo, divisor));

        List<Integer> opciones = new ArrayList<>();
        opciones.add(respuestaCorrecta);

        int rangoOpciones = Math.max(maxF + 10, respuestaCorrecta + 20);
    ...
    private void irNivelSuperado() {
        ...
        intent.putExtra(ExerciseExtras.EXTRA_EXERCISE_TYPE, ExerciseExtras.TYPE_DIVIDIR);
    ...
    private void guardarResultado() {
        if (sessionManager.isLoggedIn()) {
            ...
            values.put(DBHelper.COLUMN_TIPO_EJERCICIO, "dividir");
