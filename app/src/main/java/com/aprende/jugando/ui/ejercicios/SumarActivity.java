...
public class SumarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        juegoLayout = findViewById(R.id.juegoLayoutSumar);
        ...
        ButtonAnimUtils.addBounce(this, opcion1Button, opcion2Button, opcion3Button, opcion4Button,
                findViewById(R.id.btnVolverSumar));
    }

    private void inicializarVistas() {
        preguntaTextView = findViewById(R.id.preguntaTextViewSumar);
        timerTextView = findViewById(R.id.timerTextViewSumar);
        scoreTextView = findViewById(R.id.scoreTextViewSumar);
        nivelTextView = findViewById(R.id.nivelTextViewSumar);
        opcion1Button = findViewById(R.id.opcion1ButtonSumar);
        opcion2Button = findViewById(R.id.opcion2ButtonSumar);
        opcion3Button = findViewById(R.id.opcion3ButtonSumar);
        opcion4Button = findViewById(R.id.opcion4ButtonSumar);
    ...
    private void configurarPreguntas() {
        ...
        int num2 = minOp + random.nextInt(max - minOp + 1);
        ...
        while (opciones.size() < 4) {
            int opcion = random.nextInt(rango) + 1;
    ...
    private void irNivelSuperado() {
        ...
        intent.putExtra(ExerciseExtras.EXTRA_EXERCISE_TYPE, ExerciseExtras.TYPE_SUMAR);
    ...
    private void guardarResultado() {
        if (sessionManager.isLoggedIn()) {
            ...
            values.put(DBHelper.COLUMN_TIPO_EJERCICIO, "sumar");
